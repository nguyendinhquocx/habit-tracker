...
const CONFIG = {
  ...
  // Slack settings
  slackWebhookUrl: 'https://hooks.slack.com/services/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', // Webhook URL từ Slack App
...
function testSlackIntegration() {
  ...
  const testData = {
    ...
    config: {
      slackWebhookUrl: 'https://hooks.slack.com/services/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',
       slackChannel: '#habit'
    }
  };
